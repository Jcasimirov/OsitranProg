...
DROP TABLE SEQ_T_INFRAESTRUCTURA PURGE;
...
TCO_ID NUMBER primary key,
TCO_NOMBRE VARCHAR2(50),
TCO_FECHA_ALTA DATE,
TCO_USUARIO_ALTA VARCHAR(50),
TCO_FECHA_CAMBIO DATE,
TCO_USUARIO_CAMBIO VARCHAR(50),
TCO_FECHA_BAJA DATE,
TCO_USUARIO_BAJA VARCHAR(50),
TCO_TERMINAL VARCHAR(50),
TIN_ID NUMBER,
CONSTRAINT FK_T_INFRAESTRUCTURA_TIPO
FOREIGN KEY (TIN_ID)
REFERENCES T_INFRAESTRUCTURA_TIPO(TIN_ID)
);

CREATE SEQUENCE SEQ_T_CONCESION;

CREATE TABLE T_INFRAESTRUCTURA(
INF_ID NUMBER PRIMARY KEY,
INF_NOMBRE VARCHAR(100),
TCO_ID NUMBER,
INF_FECHA_ALTA DATE,
INF_USUARIO_ALTA VARCHAR(50),
INF_FECHA_CAMBIO DATE,
INF_USUARIO_CAMBIO VARCHAR(50),
INF_FECHA_BAJA DATE,
INF_USUARIO_BAJA VARCHAR(50),
INF_TERMINAL VARCHAR(50),
CONSTRAINT FK_T_CONCESION
FOREIGN KEY (TCO_ID)
REFERENCES T_CONCESION(TCO_ID)
);

CREATE SEQUENCE SEQ_T_INFRAESTRUCTURA;
