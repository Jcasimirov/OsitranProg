...
@ManagedBean(name = "asignarResponsable_AeropuertoMB")
@ViewScoped
public class AsignarResponsableSupervisionAeropuertos {
...
// de  abel 
    ...
    private InfraestructuraVO infraestructuraVO;
...
//get y set
    ...
    public void seleccionarEmpresa(ActionEvent actionEvent) {
        ...
        int validaReg = 0;
        try{
         validaReg = asignarResponsableSupervisionServiceImpl.ValidaAsignación(contratoVO.getConId(), contratoVO.getTinId(), contratoCompromisoSeleccionado, contratoVO.getCsiId(), codigoAeropuerto, codigoInversion, empresa.getTdoId(), empresa.getSupNroDocumento(), 1);
             }catch (Exception e){
    ...
    public void seleccionarSupervisor() {
        ...
        for (SupervisorInversionesVO supervisor : listarSupervisoresxInfraestructura) {
            if (supervisor.getTsiId() == codigoSupervisor) {
                ...
                int validaReg = 0;
                try{
                 validaReg = asignarResponsableSupervisionServiceImpl.ValidaAsignación(contratoVO.getConId(), contratoVO.getTinId(), contratoCompromisoSeleccionado, contratoVO.getCsiId(),codigoAeropuerto , codigoInversion, supervisor.getTdoId(), supervisor.getTsiNroDocumento(), 1);
                     }catch (Exception e){
                         System.out.println(e);
                     }
                if(validaReg == 0){
