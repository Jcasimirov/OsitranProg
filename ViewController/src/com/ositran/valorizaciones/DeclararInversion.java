...
public class DeclararInversion {
    ...
    public void cargarDetalleInversion(SelectEvent event) {
        try {
            ...
            for (ValorizacionInversionAvanceDetalleVO invAvanceDetalleVO : listaInvAvanceDetalleVO) {
                ...
                invReconocimientoVO.setMontoAprobadoSinIGV(calcularIgvxItem(invReconocimientoVO.getIvrMontoAprobado(),
                                                                            true));
    ...
    public void guardarDeclaracion() {
        ...
        } else if (invVO.getInvEstadoReconocimiento().equals(new Integer("2")) && (invAvnVO.getTiaObservaciones() == null || invAvnVO.getTiaObservaciones().length() == 0)) {
            FacesContext.getCurrentInstance().addMessage(null,
                                                         new FacesMessage(FacesMessage.SEVERITY_ERROR, "Aviso",
